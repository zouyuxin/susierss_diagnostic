...
1. Check the consistency between z scores and LD matrix;

2. Detect allele switch issue (flipped sign in z score).
...
hist(out_null_sample_z, xlab='LD=GBR', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_null_IBS_z, xlab='LD=IBS', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_null_CLM_z, xlab='LD=CLM', main='Standardized Difference', breaks = 50, freq = FALSE)
...
hist(out_null_flip_sample_z, xlab='LD=GBR', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_null_flip_IBS_z, xlab='LD=IBS', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_null_flip_CLM_z, xlab='LD=CLM', main='Standardized Difference', breaks = 50, freq = FALSE)
...
hist(out_sample_z, xlab='LD=GBR', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_IBS_z, xlab='LD=IBS', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_CLM_z, xlab='LD=CLM', main='Standardized Difference', breaks = 50, freq = FALSE)
...
hist(out_flip_sample_z, xlab='LD=GBR', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_flip_IBS_z, xlab='LD=IBS', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_flip_CLM_z, xlab='LD=CLM', main='Standardized Difference', breaks = 50, freq = FALSE)
...
hist(out_flip_null_sample_z, xlab='LD=GBR', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_flip_null_IBS_z, xlab='LD=IBS', main='Standardized Difference', breaks = 50, freq = FALSE)
hist(out_flip_null_CLM_z, xlab='LD=CLM', main='Standardized Difference', breaks = 50, freq = FALSE)
