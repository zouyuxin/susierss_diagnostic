...
plot(out_null_sample_l0, out_null_sample_l1, main='LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative',
     ylim = c(2*min(out_null_sample_l0), max(out_null_sample_l1)))
abline(0,1)
plot(out_null_IBS_l0, out_null_IBS_l1, main='LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative',
     ylim = c(2*min(out_null_IBS_l0), max(out_null_IBS_l1)))
abline(0,1)
plot(out_null_CLM_l0, out_null_CLM_l1, main='LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative',
     ylim = c(2*min(out_null_CLM_l0), max(out_null_CLM_l1)))
abline(0,1)

plot(out_null_sample_l0mix, out_null_sample_l1mix, main='Mixure model LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_null_sample_l0mix), max(out_null_sample_l1mix)))
abline(0,1)
plot(out_null_IBS_l0mix, out_null_IBS_l1mix, main='Mixure model LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim = c(2*min(out_null_IBS_l0mix), max(out_null_IBS_l1mix)))
abline(0,1)
plot(out_null_CLM_l0mix, out_null_CLM_l1mix, main='Mixure model LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_null_CLM_l0mix), max(out_null_CLM_l1mix)))
abline(0,1)
```
...
par(mfrow=c(2,3))
plot(out_null_flip_sample_l0, out_null_flip_sample_l1, main='LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_null_flip_sample_l0), max(out_null_flip_sample_l1)))
points(out_null_flip_sample_l0[idx], out_null_flip_sample_l1[idx], col='red', pch=16)
abline(0,1)
plot(out_null_flip_IBS_l0, out_null_flip_IBS_l1, main='LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_null_flip_IBS_l0), max(out_null_flip_IBS_l1)))
points(out_null_flip_IBS_l0[idx], out_null_flip_IBS_l1[idx], col='red', pch=16)
abline(0,1)
plot(out_null_flip_CLM_l0, out_null_flip_CLM_l1, main='LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_null_flip_CLM_l0), max(out_null_flip_CLM_l1)))
points(out_null_flip_CLM_l0[idx], out_null_flip_CLM_l1[idx], col='red', pch=16)
abline(0,1)

plot(out_null_flip_sample_l0mix, out_null_flip_sample_l1mix, main='Mixure model LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_null_flip_sample_l0mix), max(out_null_flip_sample_l1mix)))
points(out_null_flip_sample_l0mix[idx], out_null_flip_sample_l1mix[idx], col='red', pch=16)
abline(0,1)
plot(out_null_flip_IBS_l0mix, out_null_flip_IBS_l1mix, main='Mixure model LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_null_flip_IBS_l0mix), max(out_null_flip_IBS_l1mix)))
points(out_null_flip_IBS_l0mix[idx], out_null_flip_IBS_l1mix[idx], col='red', pch=16)
abline(0,1)
plot(out_null_flip_CLM_l0mix, out_null_flip_CLM_l1mix, main='Mixure model LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_null_flip_CLM_l0mix), max(out_null_flip_CLM_l1mix)))
...
```{r}
par(mfrow=c(2,3))
plot(out_null_sample_lr, out_null_flip_sample_lr, ylim=c(-1000,500), xlim=c(min(out_null_sample_lr), 100),
...
plot(out_null_IBS_lr, out_null_flip_IBS_lr,
     xlab='logLR from Simu1.1',
     ylab='logLR from Simu1.2', main='LD=IBS',xlim=c(min(out_null_IBS_lr), 100),ylim = c(-100, 100))
points(out_null_IBS_lr[idx], out_null_flip_IBS_lr[idx], col='red', pch=16)
abline(0,1)
abline(h=0,v=0,lty=4)
plot(out_null_CLM_lr, out_null_flip_CLM_lr,
     xlab='logLR from Simu1.1',
     ylab='logLR from Simu1.2', main='LD=CLM',xlim=c(min(out_null_CLM_lr), 100),ylim = c(-100, 100))
...
plot(out_null_sample_lrmix, out_null_flip_sample_lrmix,
     ...
     ylab='logLRmix from Simu1.2', main='Mixure model LD=GBR', ylim=c(-100,20), xlim=c(min(out_null_sample_lrmix), 20))
...
plot(out_null_IBS_lrmix, out_null_flip_IBS_lrmix,
     xlab='logLRmix from Simu1.1',
     ylab='logLRmix from Simu1.2', main='Mixure model LD=IBS', ylim=c(-100,20), xlim=c(min(out_null_IBS_lrmix), 20))
points(out_null_IBS_lrmix[idx], out_null_flip_IBS_lrmix[idx], col='red', pch=16)
abline(0,1)
abline(h=0,v=0,lty=4)
plot(out_null_CLM_lrmix, out_null_flip_CLM_lrmix,
     xlab='logLRmix from Simu1.1',
     ylab='logLRmix from Simu1.2', main='Mixure model LD=CLM', ylim=c(-100,20), xlim=c(min(out_null_CLM_lrmix), 20))
...
plot(out_sample_l0, out_sample_l1, main='LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative',
     ylim=c(2*min(out_sample_l0), max(out_sample_l1)))
abline(0,1)
plot(out_IBS_l0, out_IBS_l1, main='LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative',
     ylim=c(2*min(out_IBS_l0), max(out_IBS_l1)))
abline(0,1)
plot(out_CLM_l0, out_CLM_l1, main='LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative',
     ylim=c(2*min(out_CLM_l0), max(out_CLM_l1)))
abline(0,1)

plot(out_sample_l0mix, out_sample_l1mix, main='Mixture model LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_sample_l0mix), max(out_sample_l1mix)))
abline(0,1)
plot(out_IBS_l0mix, out_IBS_l1mix, main='Mixture model LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_IBS_l0mix), max(out_IBS_l1mix)))
abline(0,1)
plot(out_CLM_l0mix, out_CLM_l1mix, main='Mixture model LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_CLM_l0mix), max(out_CLM_l1mix)))
abline(0,1)
```
...
plot(out_flip_sample_l0, out_flip_sample_l1, main='LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative',
     ylim=c(2*min(out_flip_sample_l0), max(out_flip_sample_l1)))
...
plot(out_flip_IBS_l0, out_flip_IBS_l1, main='LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative',
     ylim=c(2*min(out_flip_IBS_l0), max(out_flip_IBS_l1)))
...
plot(out_flip_CLM_l0, out_flip_CLM_l1, main='LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative',
     ylim=c(2*min(out_flip_CLM_l0), max(out_flip_CLM_l1)))
points(out_flip_CLM_l0[idx], out_flip_CLM_l1[idx], col='red', pch=16)
abline(0,1)

plot(out_flip_sample_l0mix, out_flip_sample_l1mix, main='Mixture model LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_flip_sample_l0mix), max(out_flip_sample_l1mix)))
points(out_flip_sample_l0mix[idx], out_flip_sample_l1mix[idx], col='red', pch=16)
abline(0,1)
plot(out_flip_IBS_l0mix, out_flip_IBS_l1mix, main='Mixture model LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_flip_IBS_l0mix), max(out_flip_IBS_l1mix)))
points(out_flip_IBS_l0mix[idx], out_flip_IBS_l1mix[idx], col='red', pch=16)
abline(0,1)
plot(out_flip_CLM_l0mix, out_flip_CLM_l1mix, main='Mixture model LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_flip_CLM_l0mix), max(out_flip_CLM_l1mix)))
...
```{r}
par(mfrow=c(2,3))
plot(out_sample_lr, out_flip_sample_lr, ylim=c(-1000,500), xlim = c(min(out_sample_lr), 200), 
...
plot(out_IBS_lr, out_flip_IBS_lr,
     xlab='logLR from Simu2.1',
     ylab='logLR from Simu2.2', main='LD=IBS', xlim = c(min(out_IBS_lr), 100), ylim=c(-100,200))
points(out_IBS_lr[idx], out_flip_IBS_lr[idx], col='red', pch=16)
abline(0,1)
abline(h=0, v=0, lty=4)
plot(out_CLM_lr, out_flip_CLM_lr,
     xlab='logLR from Simu2.1',
     ylab='logLR from Simu2.2', main='LD=CLM', xlim = c(min(out_CLM_lr), 100), ylim=c(-100,200))
points(out_CLM_lr[idx], out_flip_CLM_lr[idx], col='red', pch=16)
abline(0,1)
abline(h=0, v=0, lty=4)

plot(out_sample_lrmix, out_flip_sample_lrmix, xlim=c(min(out_sample_lrmix),10), ylim=c(-50,20),
...
abline(0,1)
abline(h=0, v=0, lty=4)
plot(out_IBS_lrmix, out_flip_IBS_lrmix,xlim=c(min(out_IBS_lrmix),10), ylim=c(-50,20),
     xlab='logLRmix from Simu2.1',
     ylab='logLRmix from Simu2.2', main='LD=IBS')
points(out_IBS_lrmix[idx], out_flip_IBS_lrmix[idx], col='red', pch=16)
abline(0,1)
abline(h=0, v=0, lty=4)
plot(out_CLM_lrmix, out_flip_CLM_lrmix,xlim=c(min(out_CLM_lrmix),10), ylim=c(-50,20),
     xlab='logLRmix from Simu2.1',
...
par(mfrow=c(2,3))
plot(out_flip_null_sample_l0, out_flip_null_sample_l1, main='LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim = c(2*min(out_flip_null_sample_l0), max(out_flip_null_sample_l1)))
points(out_flip_null_sample_l0[idx], out_flip_null_sample_l1[idx], col='red', pch=16)
abline(0,1)
plot(out_flip_null_IBS_l0, out_flip_null_IBS_l1, main='LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_flip_null_IBS_l0), max(out_flip_null_IBS_l1)))
points(out_flip_null_IBS_l0[idx], out_flip_null_IBS_l1[idx], col='red', pch=16)
abline(0,1)
plot(out_flip_null_CLM_l0, out_flip_null_CLM_l1, main='LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_flip_null_CLM_l0), max(out_flip_null_CLM_l1)))
points(out_flip_null_CLM_l0[idx], out_flip_null_CLM_l1[idx], col='red', pch=16)
abline(0,1)

plot(out_flip_null_sample_l0mix, out_flip_null_sample_l1mix, main='Mixture model LD=GBR', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_flip_null_sample_l0mix), max(out_flip_null_sample_l1mix)))
points(out_flip_null_sample_l0mix[idx], out_flip_null_sample_l1mix[idx], col='red', pch=16)
abline(0,1)
plot(out_flip_null_IBS_l0mix, out_flip_null_IBS_l1mix, main='Mixture model LD=IBS', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_flip_null_IBS_l0mix), max(out_flip_null_IBS_l1mix)))
points(out_flip_null_IBS_l0mix[idx], out_flip_null_IBS_l1mix[idx], col='red', pch=16)
abline(0,1)
plot(out_flip_null_CLM_l0mix, out_flip_null_CLM_l1mix, main='Mixture model LD=CLM', xlab='log likelihood under null', ylab='log likelihood under alternative', ylim=c(2*min(out_flip_null_CLM_l0mix), max(out_flip_null_CLM_l1mix)))
...
```{r}
par(mfrow=c(2,3))
plot(out_sample_lr, out_flip_null_sample_lr, ylim=c(-1000,500), xlim = c(min(out_sample_lr), 10),
     xlab='logLR from Simu2.1',
     ylab='logLR from Simu2.3', main='LD=GBR')
points(out_sample_lr[idx], out_flip_null_sample_lr[idx], col='red', pch=16)
abline(0,1)
abline(h=0,v=0,lty=4)
plot(out_IBS_lr, out_flip_null_IBS_lr,ylim=c(-100,100), xlim = c(min(out_IBS_lr), 30),
     xlab='logLR from Simu2.1',
     ylab='logLR from Simu2.3', main='LD=IBS')
points(out_IBS_lr[idx], out_flip_null_IBS_lr[idx], col='red', pch=16)
abline(0,1)
abline(h=0,v=0,lty=4)
plot(out_CLM_lr, out_flip_null_CLM_lr,ylim=c(-100,100), xlim = c(min(out_CLM_lr), 30),
     xlab='logLR from Simu2.1',
...
plot(out_sample_lrmix, out_flip_null_sample_lrmix, xlim=c(min(out_sample_lrmix),10), ylim=c(-100,10),
     xlab='logLRmix from Simu2.1',
     ylab='logLRmix from Simu2.3', main='LD=GBR')
points(out_sample_lrmix[idx], out_flip_null_sample_lrmix[idx], col='red', pch=16)
abline(0,1)
abline(h=0,v=0,lty=4)
plot(out_IBS_lrmix, out_flip_null_IBS_lrmix,xlim=c(min(out_IBS_lrmix),10), ylim=c(-100,10),
     xlab='logLRmix from Simu2.1',
     ylab='logLRmix from Simu2.3', main='LD=IBS')
points(out_IBS_lrmix[idx], out_flip_null_IBS_lrmix[idx], col='red', pch=16)
abline(0,1)
abline(h=0,v=0,lty=4)
plot(out_CLM_lrmix, out_flip_null_CLM_lrmix,xlim=c(min(out_CLM_lrmix),10), ylim=c(-100,10),
     xlab='logLRmix from Simu2.1',
